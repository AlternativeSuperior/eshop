				...
				<div class="row">
					<div class="col-sm-4">
						<div class=" logo pull-left">
							<a href="index.html"><img class='main-logo' src="/images/home/logo.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="checkout.html"><i class="fa fa-crosshairs"></i> Оплата</a></li>
					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="single-widget">
							...
							<form action="#" class="searchform">
								...
								<p>Подпишитесь на рассылку <br />и первыми узнавайте о выгодных предложениях!</p>
							</form>
						</div>
					</div>
